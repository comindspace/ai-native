...
Этот `How To` нужен, чтобы команда не читала весь Starter Kit подряд, а использовала его как рабочий маршрут запуска проекта.
...
- нужно стандартизировать запуск нового проекта внутри команды.
