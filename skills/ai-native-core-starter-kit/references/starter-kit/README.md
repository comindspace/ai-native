...
**Дата:** 2026-04-22  
**Статус:** `v0.2`  
**Назначение:** базовая стартовая сборка для запуска проектов `AI-Native Core`
...
Это рабочая стартовая сборка, которую команда внедрения адаптирует под конкретную компанию, чтобы:
